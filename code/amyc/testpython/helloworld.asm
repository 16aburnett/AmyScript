...
main:
         ...
         ; [rbp - 8] - IntArray arr (<unset-scope-name>)
...
; ========================================================================
         ; Class Declaration - __main____IntArray inherits __main__Object
            ...
            section .data
               ...
               dq .__method____main____IntArray____pushBack__int ; 0
               dq .__method____main____IntArray____popBack ; 1
               dq .__method____main____IntArray____get__int ; 2
               dq .__method____main____IntArray____set__int__int ; 3
            section .text
   ;---------------------------------------------------------------------
            ; Field - int[] IntArray::data
            section .data
            .__field____main____IntArray____data: dq 1
            section .text
   ;---------------------------------------------------------------------
   ;---------------------------------------------------------------------
            ; Field - int IntArray::size
            section .data
            .__field____main____IntArray____size: dq 2
            section .text
   ;---------------------------------------------------------------------
   ;---------------------------------------------------------------------
            ; Field - int IntArray::capacity
            section .data
            .__field____main____IntArray____capacity: dq 3
            section .text
   ;---------------------------------------------------------------------
         ; skip over class methods
         jmp .__endclass____main____IntArray
   ;---------------------------------------------------------------------
            ; Constructor Declaration - IntArray::IntArray() -> IntArray
            jmp .__end__ctor____main____IntArray____IntArray
            ...
            ; Function Header:
               ...
               ; Creating Class Instance
                  ...
                  mov qword [rax + 0], .__dtable____main____IntArray ; this[0] = &dtable
               ; Parameters
            ; Body
      ;------------------------------------------------------------------
               ; Code Block
                  ; Assignment - '='
                     ...
                     ; LHS
                        ; Member Accessor Assignment
                           ...
                           ; RHS
                              push qword [.__field____main____IntArray____capacity] ; 
                           pop rdi ; rhs
                           pop rbx ; lhs
                     pop rdx ; rhs value
                        ...
                        ; Member Accessor Assignment
                           ; LHS
                              ; This keyword
                                 push qword [rbp - 8] ; __this
                           ; RHS
                              push qword [.__field____main____IntArray____size] ; 
                           pop rdi ; rhs
                           pop rbx ; lhs
                     pop rdx ; rhs value
                     mov qword [rbx + 8*rdi], rdx
                           ...
                           ; Member Accessor
                              ; LHS
                                 ; This keyword
                                    push qword [rbp - 8] ; __this
                              ; RHS
                                 push qword [.__field____main____IntArray____capacity] ; stored index associated with field that is being accessed
                              pop rdx ; rhs
                              pop rax ; lhs
                        ...
                        ; Member Accessor Assignment
                           ; LHS
                              ; This keyword
                                 push qword [rbp - 8] ; __this
                           ; RHS
                              push qword [.__field____main____IntArray____data] ; 
                           pop rdi ; rhs
                           pop rbx ; lhs
                     pop rdx ; rhs value
                     mov qword [rbx + 8*rdi], rdx
...
;------------------------------------------------------------------------
         ...
         jmp .__end__method____main____IntArray____pushBack__int
         .__method____main____IntArray____pushBack__int:
            ...
            ; Parameters
               ; Param: val [rbp + 24] (__main____IntArray__pushBack__val)
            ; Body
      ;------------------------------------------------------------------
               ; Code Block
         ;---------------------------------------------------------------
                                    ...
                                    ; Member Accessor
                                       ; LHS
                                          ; This keyword
                                             push qword [rbp - 8] ; __this
                                       ; RHS
                                          push qword [.__field____main____IntArray____size] ; stored index associated with field that is being accessed
                                       pop rdx ; rhs
                                       pop rax ; lhs
                                       push qword [rax + 8*rdx] ; lhs.rhs
                                 ; RHS
                           ...
                           ; Assignment - '='
                              ...
                              ; LHS
                                 ; Variable Declaration - nData
                                    mov rax, qword [rbp - 16]  ; __main____IntArray__pushBack__block__1__if__2__block__3__nData
                              pop rdx ; rhs value
                              ...
                              ; Assignment - '='
                                 ...
                                 ; LHS
                                    ; Variable Declaration - i
                                       mov rax, qword [rbp - 24]  ; __main____IntArray__pushBack__block__1__if__2__block__3__for__4__i
                                 pop rdx ; rhs value
                                                ...
                                                ; Member Accessor
                                                   ; LHS
                                                      ; This keyword
                                                         push qword [rbp - 8] ; __this
                                                   ; RHS
                                                      push qword [.__field____main____IntArray____data] ; stored index associated with field that is being accessed
                                                   pop rdx ; rhs
                                                   pop rax ; lhs
                                                   push qword [rax + 8*rdx] ; lhs.rhs
                                             ; OFFSET
                        ...
                        ; Member Accessor Assignment
                           ; LHS
                              ; This keyword
                                 push qword [rbp - 8] ; __this
                           ; RHS
                              push qword [.__field____main____IntArray____size] ; size
                           pop rdi ; rhs
                           pop rbx ; lhs
...
;------------------------------------------------------------------------
         ...
         jmp .__end__method____main____IntArray____popBack
...
;------------------------------------------------------------------------
         ...
         jmp .__end__method____main____IntArray____get__int
         .__method____main____IntArray____get__int:
            ...
            ; Setup stack frame
               ...
               ; Local Variables - Each variable is currently 64-bit (sorry not sorry)
                  ...
                  mov qword [rbp - 8], rdx ; save this to a local
            ; Parameters
               ; Param: index [rbp + 24] (__main____IntArray__get__index)
            ; Body
      ;------------------------------------------------------------------
               ; Code Block
                  ; Return
...
;------------------------------------------------------------------------
         ...
         jmp .__end__method____main____IntArray____set__int__int
         .__method____main____IntArray____set__int__int:
            ...
            ; Setup stack frame
               ...
               ; Local Variables - Each variable is currently 64-bit (sorry not sorry)
                  ...
                  mov qword [rbp - 8], rdx ; save this to a local
            ; Parameters
               ; Param: index [rbp + 24] (__main____IntArray__set__index)
               ; Param: value [rbp + 32] (__main____IntArray__set__value)
            ; Body
      ;------------------------------------------------------------------
               ; Code Block
                  ; Assignment - '='
...
; ===========================================================================
         ...
         jmp .__end____main____print__IntArray
      ...
      ;------------------------------------------------------------------
               ...
               ; Init
                  ; Assignment - '='
                     ...
                     ; LHS
                        ; Variable Declaration - i
                           mov rax, qword [rbp - 8]  ; __main__print__block__9__for__12__i
                     pop rdx ; rhs value
                     mov qword [rbp - 8], rdx
                     push rdx
                  ; Loop init result can be discarded
...
.__end____main____print__IntArray:
         ; End Function Declaration - print(IntArray) -> void
; ===========================================================================

; ===========================================================================
         ; Function Declaration - println(IntArray) -> void
         ; Skip over function declaration
         jmp .__end____main____println__IntArray
...
.__end____main____println__IntArray:
         ; End Function Declaration - println(IntArray) -> void
; ===========================================================================
         ...
         ; LHS
            ; Variable Declaration - arr
               mov rax, qword [rbp - 8]  ; __main__arr
         pop rdx ; rhs value
         mov qword [rbp - 8], rdx
         push rdx
         ; Statement results can be ignored
...
;---------------------------------------------------------------------------
         ...
         ; Assignment - '='
            ...
            ; LHS
               ; Variable Declaration - i
                  mov rax, qword [rbp - 16]  ; __main__for__15__i
            pop rdx ; rhs value
            mov qword [rbp - 16], rdx
            push rdx
         ; Loop init result can be discarded
