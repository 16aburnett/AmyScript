...
.__main____bubbleSort__Vector__tparam0__Element:
         ...
         ; [rbp - 48] - int res (<unset-scope-name>)
         ; [rbp - 56] - Element temp (<unset-scope-name>)
...
;---------------------------------------------------------------------------------
         ...
         ; LHS
         ; Variable Declaration - i
            mov rax, qword [rbp - 40]  ; __main__bubbleSort__block__120__while__121__block__122__for__123__i
         pop rdx ; rhs value
         mov qword [rbp - 40], rdx
         push rdx
         ; Loop init result can be discarded
...
;---------------------------------------------------------------------------
         ...
         ; Assignment - '='
            ...
            ; LHS
               ; Variable Declaration - res
                  mov rax, qword [rbp - 48]  ; __main__bubbleSort__block__120__while__121__block__122__for__123__block__124__res
            pop rdx ; rhs value
            mov qword [rbp - 48], rdx
            push rdx
         ; Statement results can be ignored
                  ...
                  ; Assignment - '='
                     ...
                     ; LHS
                        ; Variable Declaration - temp
                           mov rax, qword [rbp - 56]  ; __main__bubbleSort__block__120__while__121__block__122__for__123__block__124__if__125__block__126__temp
                     pop rdx ; rhs value
                     mov qword [rbp - 56], rdx
                     push rdx
                  ; Statement results can be ignored
