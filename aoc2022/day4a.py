...
while (1):
    ...
    __rhs = stack.pop()
    __main__for__11__block__12__isAInB = __rhs
    stack.append (__main__for__11__block__12__isAInB)
    # Statement results can be ignored
    stack.pop ()
    # End Statement
    ...
    __rhs = stack.pop()
    __main__for__11__block__12__isBInA = __rhs
    stack.append (__main__for__11__block__12__isBInA)
    # Statement results can be ignored
    stack.pop ()
    # End Statement
