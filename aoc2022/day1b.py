...
def __main____bubbleSort__int____Vector__tparam0__int (__main__bubbleSort__arr):
    ...
    stack.append(1)
    # LHS
    __main__bubbleSort__block__14__hasSwapped = 0
    __rhs = stack.pop()
    __main__bubbleSort__block__14__hasSwapped = __rhs
    stack.append (__main__bubbleSort__block__14__hasSwapped)
    # Statement results can be ignored
    stack.pop ()
    # End Statement
    ...
    while (1):
        ...
        stack.append(1)
        # LHS
        __main__bubbleSort__block__14__while__15__block__16__for__17__i = 0
        __rhs = stack.pop()
        __main__bubbleSort__block__14__while__15__block__16__for__17__i = __rhs
        stack.append (__main__bubbleSort__block__14__while__15__block__16__for__17__i)
        # Using an infinite loop so we can write a separate multi-line condition
        while (1):
            # Condition
            # Less Than
            ...
            if (__if__19__cond):
                ...
                stack.append (__retval)
                # LHS
                __main__bubbleSort__block__14__while__15__block__16__for__17__block__18__if__19__block__20__temp = 0
                __rhs = stack.pop()
                __main__bubbleSort__block__14__while__15__block__16__for__17__block__18__if__19__block__20__temp = __rhs
                stack.append (__main__bubbleSort__block__14__while__15__block__16__for__17__block__18__if__19__block__20__temp)
                # Statement results can be ignored
                stack.pop ()
                # End Statement
            ...
            stack.append(__main__bubbleSort__block__14__while__15__block__16__for__17__i)
            __rhs = stack.pop ()
            __main__bubbleSort__block__14__while__15__block__16__for__17__i = __main__bubbleSort__block__14__while__15__block__16__for__17__i + 1
            __res = __main__bubbleSort__block__14__while__15__block__16__for__17__i
            stack.append (__res)
        #-----------------------------------------------------------------
        #-----------------------------------------------------------------
    # End of While
...
stack.append(0)
# LHS
__main__for__21__i = 0
__rhs = stack.pop()
__main__for__21__i = __rhs
stack.append (__main__for__21__i)
# Using an infinite loop so we can write a separate multi-line condition
while (1):
    # Condition
    # Less Than
    ...
    stack.append(__main__for__21__i)
    __rhs = stack.pop ()
    __main__for__21__i = __main__for__21__i + 1
    __res = __main__for__21__i
    stack.append (__res)
#-------------------------------------------------------------------------
# Statement
...
stack.append(0)
# LHS
__main__for__23__i = 0
__rhs = stack.pop()
__main__for__23__i = __rhs
stack.append (__main__for__23__i)
# Using an infinite loop so we can write a separate multi-line condition
while (1):
    # Condition
    # Less Than
    ...
    stack.append(__main__for__23__i)
    __rhs = stack.pop ()
    __main__for__23__i = __main__for__23__i + 1
    __res = __main__for__23__i
    stack.append (__res)
#-------------------------------------------------------------------------
# Statement
# Function Call - println() -> void
