...
main:
         ...
         ; [rbp - 48] - int sumTop3Elves (<unset-scope-name>)
...
; ===========================================================================
   ...
   ; =====================================================================
            ...
            jmp .__end____main____bubbleSort__int____Vector__tparam0__int
.__main____bubbleSort__int____Vector__tparam0__int:
               ; Function Header:
                  ...
                  ; Parameters
                     ; Param: arr [rbp + 16]
                  ; Local Variables - Each variable is currently 64-bit (sorry not sorry)
                     ; [rbp - 8] - int hasSwapped (<unset-scope-name>)
                     ; [rbp - 16] - int i (<unset-scope-name>)
                     ; [rbp - 24] - int temp (<unset-scope-name>)
                     ...
                     ; Assignment - '='
                        ...
                        ; LHS
                           ; Variable Declaration - hasSwapped
                              mov rax, qword [rbp - 8]  ; __main__bubbleSort__block__15__hasSwapped
                        pop rdx ; rhs value
                        mov qword [rbp - 8], rdx
                        push rdx
                     ; Statement results can be ignored
                     ...
                     ;---------------------------------------------------
                              ...
                              ; Init
                                 ; Assignment - '='
                                    ...
                                    ; LHS
                                       ; Variable Declaration - i
                                          mov rax, qword [rbp - 16]  ; __main__bubbleSort__block__15__while__16__block__17__for__18__i
                                    pop rdx ; rhs value
                                    mov qword [rbp - 16], rdx
                                    push rdx
                                 ; Loop init result can be discarded
                                                ...
                                                ; Assignment - '='
                                                   ...
                                                   ; LHS
                                                      ; Variable Declaration - temp
                                                         mov rax, qword [rbp - 24]  ; __main__bubbleSort__block__15__while__16__block__17__for__18__block__19__if__20__block__21__temp
                                                   pop rdx ; rhs value
                                                   mov qword [rbp - 24], rdx
                                                   push rdx
                                                ; Statement results can be ignored
...
.__end____main____bubbleSort__int____Vector__tparam0__int:
            ; End Function Declaration - bubbleSort<:int:>(Vector<:int:>) -> void
   ; =====================================================================
...
;---------------------------------------------------------------------------
         ...
         ; Assignment - '='
            ...
            ; LHS
               ; Variable Declaration - i
                  mov rax, qword [rbp - 32]  ; __main__for__22__i
            pop rdx ; rhs value
...
;---------------------------------------------------------------------------
         ...
         ; Arguments
            ...
            pop rax
            mov qword [rsp + 0], rax
         ; Call bubbleSort<:int:>(Vector<:int:>)
...
;---------------------------------------------------------------------------
         ...
         ; Assignment - '='
            ...
            ; LHS
               ; Variable Declaration - i
                  mov rax, qword [rbp - 40]  ; __main__for__24__i
            pop rdx ; rhs value
...
;---------------------------------------------------------------------------
         ...
         ; RHS
            ; Addition - int, int
               ...
               push rax
         ; LHS
            ; Variable Declaration - sumTop3Elves
               mov rax, qword [rbp - 48]  ; __main__sumTop3Elves
         pop rdx ; rhs value
