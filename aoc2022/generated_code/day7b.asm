...
;---------------------------------------------------------------------------------------
         ...
         ; LHS
         ; Variable Declaration - i
         mov rax, qword [rbp - 48]  ; __main__for__45__i
         pop rdx ; rhs value
         mov qword [rbp - 48], rdx
         push rdx
         ; Loop init result can be discarded
...
;---------------------------------------------------------------------------------
         ...
         ; LHS
         ; Variable Declaration - tokens
            mov rax, qword [rbp - 56]  ; __main__for__45__block__46__tokens
         pop rdx ; rhs value
         mov qword [rbp - 56], rdx
         push rdx
         ; Statement results can be ignored
                  ...
                  ;------------------------------------------------------
                           ...
                           ; Init
                              ; Assignment - '='
                                 ...
                                 ; LHS
                                    ; Variable Declaration - j
                                       mov rax, qword [rbp - 64]  ; __main__for__45__block__46__if__47__block__48__if__49__block__50.__else__51__block__54__for__55__j
                                 pop rdx ; rhs value
...
.__endif__62:
                     ;---------------------------------------------------
                              ; Assignment - '='
                                 ...
                                 ; LHS
                                    ; Variable Declaration - tokens
                                       mov rax, qword [rbp - 72]  ; __main__for__45__block__46__if__47__block__48__elif__49x1__block__59__while__60__block__61__tokens
                                 pop rdx ; rhs value
                                       ...
                                       ; Assignment - '='
                                          ...
                                          ; LHS
                                             ; Variable Declaration - dir
                                                mov rax, qword [rbp - 80]  ; __main__for__45__block__46__if__47__block__48__elif__49x1__block__59__while__60__block__61__if__63__block__64__dir
                                          pop rdx ; rhs value
                        ...
                        ;------------------------------------------------
                                 ; Code Block
                                    ; Assignment - '='
                                       ...
                                       ; LHS
                                          ; Variable Declaration - size
                                             mov rax, qword [rbp - 88]  ; __main__for__45__block__46__if__47__block__48__elif__49x1__block__59__while__60__block__61.__else__63__block__65__size
                                       pop rdx ; rhs value
                                    ...
                                    ; Assignment - '='
                                       ...
                                       ; LHS
                                          ; Variable Declaration - f
                                             mov rax, qword [rbp - 96]  ; __main__for__45__block__46__if__47__block__48__elif__49x1__block__59__while__60__block__61.__else__63__block__65__f
                                       pop rdx ; rhs value
...
;---------------------------------------------------------------------------------------
         ...
         ; LHS
         ; Variable Declaration - i
         mov rax, qword [rbp - 144]  ; __main__for__82__i
         pop rdx ; rhs value
