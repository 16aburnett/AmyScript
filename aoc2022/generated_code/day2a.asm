...
main:
         ...
         ; [rbp - 40] - char ROCK1 (<unset-scope-name>)
         ; [rbp - 48] - char PAPER1 (<unset-scope-name>)
         ; [rbp - 56] - char SCISSORS1 (<unset-scope-name>)
         ...
         ; Assignment - '='
            ; RHS
               ; Char Literal
                  push 'X'
            ; LHS
               ; Variable Declaration - ROCK1
                  mov rax, qword [rbp - 40]  ; __main__ROCK1
            pop rdx ; rhs value
            mov byte [rbp - 40], dl
            push rdx
         ; Statement results can be ignored
         ...
         ; Assignment - '='
            ; RHS
               ; Char Literal
                  push 'Y'
            ; LHS
               ; Variable Declaration - PAPER1
                  mov rax, qword [rbp - 48]  ; __main__PAPER1
            pop rdx ; rhs value
            mov byte [rbp - 48], dl
            push rdx
         ; Statement results can be ignored
         ...
         ; Assignment - '='
            ; RHS
               ; Char Literal
                  push 'Z'
            ; LHS
               ; Variable Declaration - SCISSORS1
                  mov rax, qword [rbp - 56]  ; __main__SCISSORS1
            pop rdx ; rhs value
            mov byte [rbp - 56], dl
            push rdx
         ; Statement results can be ignored
         ...
         ;---------------------------------------------------------------
                  ; If-Statement
                     ; Condition
                        ...
                        pop rdx ; __cond
                        cmp rdx, 0 ; ensure condition is true
                        je .__elif__5x0 ; jump to first elif
                     ; Body
               ;---------------------------------------------------------
                        ; Code Block
                  ;------------------------------------------------------
...
.__endif__7:
                  ;------------------------------------------------------
               ;---------------------------------------------------------
                     jmp .__endif__5 ; jump to end of condition chain
            ;------------------------------------------------------------
                     ; Elif-Statement
.__elif__5x0:
                        ; Condition
                  ...
                  ;------------------------------------------------------
                           ; If-Statement
                              ; Condition
                                 ...
                                 pop rdx ; __cond
                                 cmp rdx, 0 ; ensure condition is true
                                 je .__elif__11x0 ; jump to first elif
                              ; Body
                        ;------------------------------------------------
                                 ; Code Block
                                    ; Assignment - '+='
                  ...
                  ;------------------------------------------------------
                           ; If-Statement
                              ; Condition
                                 ...
                                 pop rdx ; __cond
                                 cmp rdx, 0 ; ensure condition is true
                                 je .__elif__16x0 ; jump to first elif
                              ; Body
                        ;------------------------------------------------
                                 ; Code Block
                                    ; Assignment - '+='
