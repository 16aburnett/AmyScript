...
main:
         ...
         ; [rbp - 200] - int common_div (<unset-scope-name>)
         ; [rbp - 208] - int i (<unset-scope-name>)
         ; [rbp - 216] - int r (<unset-scope-name>)
         ; [rbp - 224] - int m (<unset-scope-name>)
         ; [rbp - 232] - Monkey monkey (<unset-scope-name>)
         ; [rbp - 240] - Vector<:int:> monkey_items (<unset-scope-name>)
         ; [rbp - 248] - int i (<unset-scope-name>)
         ; [rbp - 256] - int worry_level (<unset-scope-name>)
         ; [rbp - 264] - int firstmax (<unset-scope-name>)
         ; [rbp - 272] - int secondmax (<unset-scope-name>)
         ; [rbp - 280] - int i (<unset-scope-name>)
         ; [rbp - 288] - int i (<unset-scope-name>)
...
;---------------------------------------------------------------------------------
         ...
         pop rbp
         ret
         jmp .__endif__41 ; jump to end of condition chain
         ; End of if
.__endif__41:
;---------------------------------------------------------------------------------
         ; Assignment - '='
         ...
         mov rax, qword [rbp - 8]  ; __main__strlen__block__40__size
         pop rdx ; rhs value
         mov qword [rbp - 8], rdx
         push rdx
         ; Statement results can be ignored
...
;------------------------------------------------------------------------------------
         ...
         mov rax, qword [rbp - 8]  ; __main__strcmp__block__43__asize
         pop rdx ; rhs value
         mov qword [rbp - 8], rdx
         push rdx
         ; Statement results can be ignored
         ...
         mov rax, qword [rbp - 16]  ; __main__strcmp__block__43__bsize
         pop rdx ; rhs value
         mov qword [rbp - 16], rdx
         push rdx
         ; Statement results can be ignored
...
;---------------------------------------------------------------------------------
         ...
         ; LHS
         ; Variable Declaration - i
            mov rax, qword [rbp - 24]  ; __main__strcmp__block__43__for__45__i
         pop rdx ; rhs value
         mov qword [rbp - 24], rdx
         push rdx
         ; Loop init result can be discarded
...
;------------------------------------------------------------------------------------
         ...
         mov rax, qword [rbp - 8]  ; __main__substr__block__49__res
         pop rdx ; rhs value
         mov qword [rbp - 8], rdx
         push rdx
         ; Statement results can be ignored
...
;---------------------------------------------------------------------------------
         ...
         ; LHS
         ; Variable Declaration - i
            mov rax, qword [rbp - 16]  ; __main__substr__block__49__for__50__i
         pop rdx ; rhs value
         mov qword [rbp - 16], rdx
         push rdx
         ; Loop init result can be discarded
...
;------------------------------------------------------------------------------------
         ...
         ; LHS
         ; Variable Declaration - size
         mov rax, qword [rbp - 8]  ; __main__first_index_of__block__52__size
         pop rdx ; rhs value
         mov qword [rbp - 8], rdx
         push rdx
         ; Statement results can be ignored
...
;---------------------------------------------------------------------------------
         ...
         ; LHS
         ; Variable Declaration - i
            mov rax, qword [rbp - 16]  ; __main__first_index_of__block__52__for__53__i
         pop rdx ; rhs value
         mov qword [rbp - 16], rdx
         push rdx
         ; Loop init result can be discarded
...
;------------------------------------------------------------------------------------
         ...
         mov rax, qword [rbp - 8]  ; __main__split__block__56__tokens
         pop rdx ; rhs value
         mov qword [rbp - 8], rdx
         push rdx
         ; Statement results can be ignored
         ...
         ; LHS
         ; Variable Declaration - size
         mov rax, qword [rbp - 16]  ; __main__split__block__56__size
         pop rdx ; rhs value
         mov qword [rbp - 16], rdx
         push rdx
         ; Statement results can be ignored
         ...
         ; LHS
         ; Variable Declaration - i
         mov rax, qword [rbp - 24]  ; __main__split__block__56__i
         pop rdx ; rhs value
         mov qword [rbp - 24], rdx
         push rdx
         ; Statement results can be ignored
         ...
         mov rax, qword [rbp - 32]  ; __main__split__block__56__j
         pop rdx ; rhs value
                  ...
                  ; Assignment - '='
                     ...
                     ; LHS
                        ; Variable Declaration - count
                           mov rax, qword [rbp - 40]  ; __main__split__block__56__while__57__block__58__if__59__block__60__count
                     pop rdx ; rhs value
                  ...
                  ; Assignment - '='
                     ...
                     ; LHS
                        ; Variable Declaration - k
                           mov rax, qword [rbp - 48]  ; __main__split__block__56__while__57__block__58__if__59__block__60__k
                     pop rdx ; rhs value
         ...
         ;---------------------------------------------------------------
                  ...
                  ; Init
                     ; Assignment - '='
                        ...
                        ; LHS
                           ; Variable Declaration - k
                              mov rax, qword [rbp - 56]  ; __main__split__block__56__while__57__block__58__if__59__block__60__for__63__k
                        pop rdx ; rhs value
...
;---------------------------------------------------------------------------------------------
         ...
         mov rax, qword [rbp - 56]  ; __main__for__80__l
         pop rdx ; rhs value
         mov qword [rbp - 56], rdx
         push rdx
         ; Loop init result can be discarded
...
;---------------------------------------------------------------------------------------
         ...
         mov rax, qword [rbp - 64]  ; __main__for__80__block__81__monkey
         pop rdx ; rhs value
         ...
         mov rax, qword [rbp - 72]  ; __main__for__80__block__81__items_str
         pop rdx ; rhs value
         ...
         mov rax, qword [rbp - 80]  ; __main__for__80__block__81__tokens0
         pop rdx ; rhs value
...
;------------------------------------------------------------------------------------
         ...
         ; LHS
         ; Variable Declaration - i
         mov rax, qword [rbp - 88]  ; __main__for__80__block__81__for__82__i
         pop rdx ; rhs value
...
;------------------------------------------------------------------------------
         ...
         ; LHS
            ; Variable Declaration - item_str
               mov rax, qword [rbp - 96]  ; __main__for__80__block__81__for__82__block__83__item_str
         pop rdx ; rhs value
         ...
         ; LHS
            ; Variable Declaration - item
               mov rax, qword [rbp - 104]  ; __main__for__80__block__81__for__82__block__83__item
         pop rdx ; rhs value
...
;------------------------------------------------------------------------------------
         ...
         ; LHS
         ; Variable Declaration - i
         mov rax, qword [rbp - 112]  ; __main__for__80__block__81__for__84__i
         pop rdx ; rhs value
...
;------------------------------------------------------------------------------
         ...
         ; LHS
            ; Variable Declaration - tokens1
               mov rax, qword [rbp - 120]  ; __main__for__80__block__81__if__85__block__86__tokens1
         pop rdx ; rhs value
...
;---------------------------------------------------------------------------
         ...
         ; Assignment - '='
            ...
            ; LHS
               ; Variable Declaration - j
                  mov rax, qword [rbp - 128]  ; __main__for__80__block__81__if__85__block__86__for__90__j
            pop rdx ; rhs value
...
;---------------------------------------------------------------------------------
         ...
         ; LHS
         ; Variable Declaration - tokens1
            mov rax, qword [rbp - 136]  ; __main__for__80__block__81.__else__85__block__91__tokens1
         pop rdx ; rhs value
...
;------------------------------------------------------------------------------
         ...
         ; LHS
            ; Variable Declaration - j
               mov rax, qword [rbp - 144]  ; __main__for__80__block__81.__else__85__block__91__for__95__j
         pop rdx ; rhs value
...
;------------------------------------------------------------------------------------
         ...
         mov rax, qword [rbp - 152]  ; __main__for__80__block__81__tokens2
         pop rdx ; rhs value
...
;------------------------------------------------------------------------------------
         ...
         ; LHS
         ; Variable Declaration - j
         mov rax, qword [rbp - 160]  ; __main__for__80__block__81__for__96__j
         pop rdx ; rhs value
...
;------------------------------------------------------------------------------------
         ...
         mov rax, qword [rbp - 168]  ; __main__for__80__block__81__tokens3
         pop rdx ; rhs value
...
;------------------------------------------------------------------------------------
         ...
         ; LHS
         ; Variable Declaration - j
         mov rax, qword [rbp - 176]  ; __main__for__80__block__81__for__97__j
         pop rdx ; rhs value
...
;------------------------------------------------------------------------------------
         ...
         mov rax, qword [rbp - 184]  ; __main__for__80__block__81__tokens4
         pop rdx ; rhs value
...
;------------------------------------------------------------------------------------
         ...
         ; LHS
         ; Variable Declaration - j
         mov rax, qword [rbp - 192]  ; __main__for__80__block__81__for__98__j
         pop rdx ; rhs value
...
;------------------------------------------------------------------------------------
         ...
         ; LHS
         ; Variable Declaration - i
         mov rax, qword [rbp - 8]  ; __main__println__block__99__for__100__i
         pop rdx ; rhs value
         mov qword [rbp - 8], rdx
         push rdx
         ; Loop init result can be discarded
...
; =============================================================================================
         ...
         push rax
         ; LHS
         ; Variable Declaration - common_div
         mov rax, qword [rbp - 200]  ; __main__common_div
         pop rdx ; rhs value
...
;---------------------------------------------------------------------------------------------
         ...
         ; LHS
         ; Variable Declaration - i
         mov rax, qword [rbp - 208]  ; __main__for__102__i
         pop rdx ; rhs value
...
;---------------------------------------------------------------------------------------
         ...
         push qword [rax + 8*rdx] ; lhs.rhs
         pop rdx ; rhs value
         mov rax, qword [rbp - 200] ; read lhs value
         imul rax, rdx      ; lhs = lhs * rhs
         mov qword [rbp - 200], rax ; write back to lhs
         push rax          ; push result for other expressions
         ; Statement results can be ignored
         pop rdx
;---------------------------------------------------------------------------------------
...
;---------------------------------------------------------------------------------------------
         ...
         mov rax, qword [rbp - 216]  ; __main__for__104__r
         pop rdx ; rhs value
...
;------------------------------------------------------------------------------------
         ...
         mov rax, qword [rbp - 224]  ; __main__for__104__block__105__for__106__m
         pop rdx ; rhs value
...
;------------------------------------------------------------------------------
         ...
         ; LHS
            ; Variable Declaration - monkey
               mov rax, qword [rbp - 232]  ; __main__for__104__block__105__for__106__block__107__monkey
         pop rdx ; rhs value
         ...
         ; LHS
            ; Variable Declaration - monkey_items
               mov rax, qword [rbp - 240]  ; __main__for__104__block__105__for__106__block__107__monkey_items
         pop rdx ; rhs value
...
;---------------------------------------------------------------------------
         ...
         ; Assignment - '='
            ...
            ; LHS
               ; Variable Declaration - i
                  mov rax, qword [rbp - 248]  ; __main__for__104__block__105__for__106__block__107__for__108__i
            pop rdx ; rhs value
               ...
               ; Assignment - '='
                  ...
                  ; LHS
                     ; Variable Declaration - worry_level
                        mov rax, qword [rbp - 256]  ; __main__for__104__block__105__for__106__block__107__for__108__block__109__worry_level
                  pop rdx ; rhs value
      ...
      ;------------------------------------------------------------------
               ; If-Statement
                  ; Condition
                     ...
                     pop rdx ; __cond
                     cmp rdx, 0 ; ensure condition is true
                     je .__elif__110x0 ; jump to first elif
                  ; Body
                     ; Assignment - '+='
                        ; RHS
                           ; Member Accessor
                              ...
                              push qword [rax + 8*rdx] ; lhs.rhs
                        pop rdx ; rhs value
                        mov rax, qword [rbp - 256] ; read lhs value
                        add rax, rdx      ; add lhs and rhs
                        mov qword [rbp - 256], rax ; write back to lhs
                        push rax          ; push result for other expressions
                     ; Statement results can be ignored
                     pop rdx
...
;---------------------------------------------------------------------------------------------
         ...
         mov rax, qword [rbp - 264]  ; __main__firstmax
         pop rdx ; rhs value
         ...
         mov rax, qword [rbp - 272]  ; __main__secondmax
         pop rdx ; rhs value
...
;---------------------------------------------------------------------------------------------
         ...
         ; LHS
         ; Variable Declaration - i
         mov rax, qword [rbp - 280]  ; __main__for__112__i
         pop rdx ; rhs value
...
;---------------------------------------------------------------------------------------------
         ...
         ; LHS
         ; Variable Declaration - i
         mov rax, qword [rbp - 288]  ; __main__for__113__i
         pop rdx ; rhs value
