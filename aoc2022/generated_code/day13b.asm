...
main:
         ...
         ; [rbp - 48] - Vector<:Element:> elements (<unset-scope-name>)
         ; [rbp - 56] - Element e0 (<unset-scope-name>)
         ; [rbp - 64] - Vector<:Element:> e1 (<unset-scope-name>)
         ; [rbp - 72] - Element e2 (<unset-scope-name>)
         ; [rbp - 80] - Vector<:Element:> e3 (<unset-scope-name>)
         ; [rbp - 88] - Element divider2 (<unset-scope-name>)
         ; [rbp - 96] - Element divider6 (<unset-scope-name>)
         ; [rbp - 104] - int l (<unset-scope-name>)
         ; [rbp - 112] - Pair<:Element, int:> p0 (<unset-scope-name>)
         ; [rbp - 120] - int divider2i (<unset-scope-name>)
         ; [rbp - 128] - int divider6i (<unset-scope-name>)
...
.__main____is_correct_order__Element__Element:
         ...
         ; [rbp - 48] - int wasANum (<unset-scope-name>)
         ; [rbp - 56] - Element newnum (<unset-scope-name>)
         ; [rbp - 64] - Element newnum (<unset-scope-name>)
         ; [rbp - 72] - int res (<unset-scope-name>)
         ; [rbp - 80] - Element a_ (<unset-scope-name>)
         ; [rbp - 88] - Element b_ (<unset-scope-name>)
...
;------------------------------------------------------------------------------------------
         ...
         push rax
         ; LHS
         ; Variable Declaration - wasANum
         mov rax, qword [rbp - 48]  ; __main__is_correct_order__block__95__wasANum
         pop rdx ; rhs value
         mov qword [rbp - 48], rdx
         push rdx
         ; Statement results can be ignored
...
;------------------------------------------------------------------------------------
         ...
         mov rax, qword [rbp - 56]  ; __main__is_correct_order__block__95__if__110__block__111__newnum
         pop rdx ; rhs value
         mov qword [rbp - 56], rdx
         push rdx
         ; Statement results can be ignored
...
;------------------------------------------------------------------------------------
         ...
         ; LHS
         ; Variable Declaration - newnum
         mov rax, qword [rbp - 64]  ; __main__is_correct_order__block__95__if__112__block__113__newnum
         pop rdx ; rhs value
...
;------------------------------------------------------------------------------------------
         ...
         ; LHS
         ; Variable Declaration - res
         mov rax, qword [rbp - 72]  ; __main__is_correct_order__block__95__res
         pop rdx ; rhs value
...
;------------------------------------------------------------------------------------------
         ; If-Statement
         ; Condition
         ; Identifier - int wasANum
         push qword [rbp - 48]
         pop rdx ; __cond
         cmp rdx, 0 ; ensure condition is true
         je .__else__114 ; jump to else
         ; Body
;------------------------------------------------------------------------------------
         ; Code Block
         ; Assignment - '='
         ...
         mov rax, qword [rbp - 80]  ; __main__is_correct_order__block__95__if__114__block__115__a_
         pop rdx ; rhs value
...
;---------------------------------------------------------------------------------------
         ...
         mov rax, qword [rbp - 88]  ; __main__is_correct_order__block__95.__else__114__block__116__b_
         pop rdx ; rhs value
...
; ===================================================================================================
         ...
         mov rax, qword [rbp - 48]  ; __main__elements
         pop rdx ; rhs value
         mov qword [rbp - 48], rdx
         push rdx
         ; Statement results can be ignored
         ...
         mov rax, qword [rbp - 56]  ; __main__e0
         pop rdx ; rhs value
         mov qword [rbp - 56], rdx
         push rdx
         ; Statement results can be ignored
         ...
         mov rax, qword [rbp - 64]  ; __main__e1
         pop rdx ; rhs value
         mov qword [rbp - 64], rdx
         push rdx
         ; Statement results can be ignored
         ...
         push rax
         ; LHS
         ; Variable Declaration - e2
         mov rax, qword [rbp - 72]  ; __main__e2
         pop rdx ; rhs value
         mov qword [rbp - 72], rdx
         push rdx
         ; Statement results can be ignored
         ...
         push rax
         ; LHS
         ; Variable Declaration - e3
         mov rax, qword [rbp - 80]  ; __main__e3
         pop rdx ; rhs value
         mov qword [rbp - 80], rdx
         push rdx
         ; Statement results can be ignored
         ...
         push rax
         ; LHS
         ; Variable Declaration - divider2
         mov rax, qword [rbp - 88]  ; __main__divider2
         pop rdx ; rhs value
         mov qword [rbp - 88], rdx
         push rdx
         ; Statement results can be ignored
         ...
         sub rsp, 16
         ; LHS
         ; Identifier - Vector<:Element:> elements
         push qword [rbp - 48]
         pop rax ; object parameter
         mov qword [rsp + 0], rax ; place as first parameter
         ; RHS
         ...
         push rax
         ; LHS
         ; Variable Declaration - divider6
         mov rax, qword [rbp - 96]  ; __main__divider6
         pop rdx ; rhs value
...
;---------------------------------------------------------------------------------------------------
         ...
         mov rax, qword [rbp - 104]  ; __main__for__117__l
         pop rdx ; rhs value
...
.__for__117:
         ...
         push rax
         pop rdx ; rhs value
         mov rax, qword [rbp - 104] ; read lhs value
         add rax, rdx      ; add lhs and rhs
         mov qword [rbp - 104], rax ; write back to lhs
...
;------------------------------------------------------------------------------------------
         ...
         pop rdx ; __cond
         cmp rdx, 0 ; ensure condition is true
         je .__endif__119 ; jump to end
         ; Body
         ; Continue in __for__117
         jmp .__for__117
         jmp .__endif__119 ; jump to end of condition chain
         ; End of if
.__endif__119:
;------------------------------------------------------------------------------------------
         ; Assignment - '='
         ...
         mov rax, qword [rbp - 112]  ; __main__for__117__block__118__p0
         pop rdx ; rhs value
...
; ===================================================================================================
         ...
         ; Skip over function declaration
         jmp .__end____main____bubbleSort__Vector__tparam0__Element
.__main____bubbleSort__Vector__tparam0__Element:
         ...
         ; [rbp - 16] - int CONTINUE (<unset-scope-name>)
         ; [rbp - 24] - int WRONG_ORDER (<unset-scope-name>)
         ; [rbp - 32] - int hasSwapped (<unset-scope-name>)
         ; [rbp - 40] - int i (<unset-scope-name>)
         ; [rbp - 48] - int i (<unset-scope-name>)
         ; [rbp - 56] - int res (<unset-scope-name>)
         ; [rbp - 64] - Element temp (<unset-scope-name>)
...
;---------------------------------------------------------------------------------------------
         ...
         ; LHS
         ; Variable Declaration - RIGHT_ORDER
         mov rax, qword [rbp - 8]  ; __main__bubbleSort__block__120__RIGHT_ORDER
         pop rdx ; rhs value
         mov qword [rbp - 8], rdx
         push rdx
         ; Statement results can be ignored
         ...
         ; LHS
         ; Variable Declaration - CONTINUE
         mov rax, qword [rbp - 16]  ; __main__bubbleSort__block__120__CONTINUE
         pop rdx ; rhs value
         mov qword [rbp - 16], rdx
         push rdx
         ; Statement results can be ignored
         ...
         ; LHS
         ; Variable Declaration - WRONG_ORDER
         mov rax, qword [rbp - 24]  ; __main__bubbleSort__block__120__WRONG_ORDER
         pop rdx ; rhs value
         mov qword [rbp - 24], rdx
         push rdx
         ; Statement results can be ignored
         ...
         push rax
         ; LHS
         ; Variable Declaration - hasSwapped
         mov rax, qword [rbp - 32]  ; __main__bubbleSort__block__120__hasSwapped
         pop rdx ; rhs value
         mov qword [rbp - 32], rdx
         push rdx
         ; Statement results can be ignored
         ...
         ; LHS
         ; Variable Declaration - i
         mov rax, qword [rbp - 40]  ; __main__bubbleSort__block__120__i
         pop rdx ; rhs value
         mov qword [rbp - 40], rdx
         push rdx
         ; Statement results can be ignored
...
;---------------------------------------------------------------------------------
         ...
         ; LHS
         ; Variable Declaration - i
            mov rax, qword [rbp - 48]  ; __main__bubbleSort__block__120__while__121__block__122__for__123__i
         pop rdx ; rhs value
         mov qword [rbp - 48], rdx
         push rdx
         ; Loop init result can be discarded
...
;---------------------------------------------------------------------------
         ...
         ; Assignment - '='
            ...
            ; LHS
               ; Variable Declaration - res
                  mov rax, qword [rbp - 56]  ; __main__bubbleSort__block__120__while__121__block__122__for__123__block__124__res
            pop rdx ; rhs value
            mov qword [rbp - 56], rdx
            push rdx
         ; Statement results can be ignored
                  ...
                  ; Assignment - '='
                     ...
                     ; LHS
                        ; Variable Declaration - temp
                           mov rax, qword [rbp - 64]  ; __main__bubbleSort__block__120__while__121__block__122__for__123__block__124__if__125__block__126__temp
                     pop rdx ; rhs value
                     mov qword [rbp - 64], rdx
                     push rdx
                  ; Statement results can be ignored
...
.__end____main____bubbleSort__Vector__tparam0__Element:
         ; End Function Declaration - bubbleSort(Vector<:Element:>) -> void
; ===================================================================================================
         ...
         pop rax
         mov qword [rsp + 0], rax
         ; Call bubbleSort(Vector<:Element:>)
         ...
         push rax
         ; LHS
         ; Variable Declaration - divider2i
         mov rax, qword [rbp - 120]  ; __main__divider2i
         pop rdx ; rhs value
         ...
         push rax
         ; LHS
         ; Variable Declaration - divider6i
         mov rax, qword [rbp - 128]  ; __main__divider6i
         pop rdx ; rhs value
...
;---------------------------------------------------------------------------------------------------
         ...
         ; Multiplication - int, int
         ; LHS
         ; Identifier - int divider2i
         push qword [rbp - 120]
         ; RHS
         ; Identifier - int divider6i
         push qword [rbp - 128]
         pop rdx
         pop rax
         imul rax, rdx
