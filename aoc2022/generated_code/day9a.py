...
while (1):
    ...
    stack.append (__pointer[__offset])
    # LHS
    __main__for__59__block__60__line = 0
    __rhs = stack.pop()
    __main__for__59__block__60__line = __rhs
    stack.append (__main__for__59__block__60__line)
    # Statement results can be ignored
    stack.pop ()
    # End Statement
    ...
    stack.append (__res) # function call result
    # LHS
    __main__for__59__block__60__tokens = 0
    __rhs = stack.pop()
    __main__for__59__block__60__tokens = __rhs
    stack.append (__main__for__59__block__60__tokens)
    # Statement results can be ignored
    stack.pop ()
    # End Statement
    ...
    stack.append (__res) # function call result
    # LHS
    __main__for__59__block__60__amt = 0
    __rhs = stack.pop()
    __main__for__59__block__60__amt = __rhs
    stack.append (__main__for__59__block__60__amt)
    # Statement results can be ignored
    stack.pop ()
    # End Statement
    ...
    stack.append(0)
    # LHS
    __main__for__59__block__60__for__61__j = 0
    __rhs = stack.pop()
    __main__for__59__block__60__for__61__j = __rhs
    stack.append (__main__for__59__block__60__for__61__j)
    # Using an infinite loop so we can write a separate multi-line condition
    while (1):
        # Condition
        # Less Than
        ...
        stack.append(0)
        # LHS
        __main__for__59__block__60__for__61__block__62__tail_moved = 0
        __rhs = stack.pop()
        __main__for__59__block__60__for__61__block__62__tail_moved = __rhs
        stack.append (__main__for__59__block__60__for__61__block__62__tail_moved)
        # Statement results can be ignored
        stack.pop ()
        # End Statement
        ...
        stack.append (__res) # function call result
        # LHS
        __main__for__59__block__60__for__61__block__62__deltax = 0
        __rhs = stack.pop()
        __main__for__59__block__60__for__61__block__62__deltax = __rhs
        stack.append (__main__for__59__block__60__for__61__block__62__deltax)
        # Statement results can be ignored
        stack.pop ()
        # End Statement
        ...
        stack.append (__res) # function call result
        # LHS
        __main__for__59__block__60__for__61__block__62__deltay = 0
        __rhs = stack.pop()
        __main__for__59__block__60__for__61__block__62__deltay = __rhs
        stack.append (__main__for__59__block__60__for__61__block__62__deltay)
        # Statement results can be ignored
        stack.pop ()
        # End Statement
        ...
        if (__if__68__cond):
            ...
            stack.append (__res)
            # LHS
            __main__for__59__block__60__for__61__block__62__if__68__block__69__isup = 0
            __rhs = stack.pop()
            __main__for__59__block__60__for__61__block__62__if__68__block__69__isup = __rhs
            stack.append (__main__for__59__block__60__for__61__block__62__if__68__block__69__isup)
            # Statement results can be ignored
            stack.pop ()
            # End Statement
        ...
        # Condition
            ...
            stack.append (__res)
            # LHS
            __main__for__59__block__60__for__61__block__62__elif__68x0__block__73__isright = 0
            __rhs = stack.pop()
            __main__for__59__block__60__for__61__block__62__elif__68x0__block__73__isright = __rhs
            stack.append (__main__for__59__block__60__for__61__block__62__elif__68x0__block__73__isright)
            # Statement results can be ignored
            stack.pop ()
            # End Statement
        ...
        # Condition
            ...
            stack.append (__res)
            # LHS
            __main__for__59__block__60__for__61__block__62__elif__68x1__block__77__isup = 0
            __rhs = stack.pop()
            __main__for__59__block__60__for__61__block__62__elif__68x1__block__77__isup = __rhs
            stack.append (__main__for__59__block__60__for__61__block__62__elif__68x1__block__77__isup)
            # Statement results can be ignored
            stack.pop ()
            # End Statement
            ...
            stack.append (__res)
            # LHS
            __main__for__59__block__60__for__61__block__62__elif__68x1__block__77__isright = 0
            __rhs = stack.pop()
            __main__for__59__block__60__for__61__block__62__elif__68x1__block__77__isright = __rhs
            stack.append (__main__for__59__block__60__for__61__block__62__elif__68x1__block__77__isright)
            # Statement results can be ignored
            stack.pop ()
            # End Statement
        ...
        if (__if__83__cond):
            ...
            stack.append(0)
            # LHS
            __main__for__59__block__60__for__61__block__62__if__83__block__84__exists = 0
            __rhs = stack.pop()
            __main__for__59__block__60__for__61__block__62__if__83__block__84__exists = __rhs
            stack.append (__main__for__59__block__60__for__61__block__62__if__83__block__84__exists)
            # Statement results can be ignored
            stack.pop ()
            # End Statement
            ...
            stack.append(0)
            # LHS
            __main__for__59__block__60__for__61__block__62__if__83__block__84__for__85__k = 0
            __rhs = stack.pop()
            __main__for__59__block__60__for__61__block__62__if__83__block__84__for__85__k = __rhs
            stack.append (__main__for__59__block__60__for__61__block__62__if__83__block__84__for__85__k)
            # Using an infinite loop so we can write a separate multi-line condition
            while (1):
                # Condition
                # Less Than
                ...
                stack.append(__main__for__59__block__60__for__61__block__62__if__83__block__84__for__85__k)
                __rhs = stack.pop ()
                __main__for__59__block__60__for__61__block__62__if__83__block__84__for__85__k = __main__for__59__block__60__for__61__block__62__if__83__block__84__for__85__k + 1
                __res = __main__for__59__block__60__for__61__block__62__if__83__block__84__for__85__k
                stack.append (__res)
            #-------------------------------------------------------------
            #-------------------------------------------------------------
            # If-Statement
        ...
        stack.append(__main__for__59__block__60__for__61__j)
        __rhs = stack.pop ()
        __main__for__59__block__60__for__61__j = __main__for__59__block__60__for__61__j + 1
        __res = __main__for__59__block__60__for__61__j
        stack.append (__res)
    #---------------------------------------------------------------------
    #---------------------------------------------------------------------
    # Update
